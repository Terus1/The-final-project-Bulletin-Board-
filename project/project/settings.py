...
SECRET_KEY = 'django-insecure-*q4p*7plk6^mcj0=6z3cgy5pu$ul7eoc_$hgvob^8y#lwd=6_('
...
EMAIL_PORT = 465
EMAIL_HOST_USER = "coolloginpolzovatel"
EMAIL_HOST_PASSWORD = "ckxjdjjsfokfuzqi"
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
...
MANAGERS = (
    ('deletemepls', 'deletemeplsfamilia@yandex.ru',)
)

ADMINS = (
   ('coolloginpolzovatel', 'coolloginpolzovatel@yandex.ru'),
)
